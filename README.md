# Welcome
This project is the [NICI Store](http://nicistore.andretavares.com/en) encarnation of an Isomorphic (first render on the server, then Single-page App on the client) React Application for E-Commerce Storefronts and for shopping
